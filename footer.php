    		...
    		<div class="content-wrapper">
    			<div class="left">
    				...
    				<div class="address">
                        ...
                        <div class="footer--location">
                            <?php if(get_field('stables_address', 'option')) { ?>
                                <?php the_field('stables_address', 'option'); ?>
                            <?php } ?>
    
                            <?php if(get_field('stables_phone_number', 'option')) { ?>
                                <p><img src="<?php bloginfo('template_url'); ?>/images/tinyphone.png" alt="Phone Icon" class="phone"/><span><?php the_field('stables_phone_number', 'option'); ?></span></p>
                            <?php } ?>
    
                            <div style="clear:both;"></div>
    
                            <?php if(get_field('stables_direction_link', 'option')) { ?>
                            <p><a href="<?php the_field('stables_direction_link', 'option'); ?>" target="_blank">
                                <img src="<?php bloginfo('template_url'); ?>/images/tinymap.png" alt="Directions Icon" class="direction"/>
                                <span>Directions</span>
                                <img src="<?php bloginfo('template_url'); ?>/images/nextarrow.png" alt="Next Arrow" class="arrow"/>
                            </a></p>
